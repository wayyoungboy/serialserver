...
This E2E is the no-hardware smoke path: Go 1.25+, Linux, no PLC or USB-serial adapter.
On non-Linux the package has no test files because of a Linux build tag.
